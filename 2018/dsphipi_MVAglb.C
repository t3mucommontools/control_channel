...
void dsphipi_MVAglb() 
{
    ...
    //open input rootfile
    TFile *fin = new TFile("/eos/user/f/fsimone/input_files/t3mminitree_xgb_2018_13may22_ptmu3_control.root", "READ");
    cout<<"opened input file t3mminitree_xgb_2018_13may22_ptmu3_control.root"<<endl;
    ...
    TString binning_MVA = "(40, 0.1, 0.8)";
    ...
    for(int j=0; j<2; j++){
        ...
        //Control plot
        TH1F *hdata_bkg      =   new TH1F("hdata_bkg", "hdata_bkg", 40, 0.1, 0.8); //ncut, edges for variable binning
        TH1F *hdata_bkg_plus =   new TH1F("hdata_bkg_plus", "hdata_bkg_plus", 40, 0.1, 0.8);
        TH1F *hdata_bkg_minus =  new TH1F("hdata_bkg_minus", "hdata_bkg_minus", 40, 0.1, 0.8);
        TH1F *hdata_sgn =        new TH1F("hdata_sgn", "hdata_sgn", 40, 0.1, 0.8);
        TH1F *hdata_sgn_plus =   new TH1F("hdata_sgn_plus", "hdata_sgn_plus", 40, 0.1, 0.8);
        TH1F *hdata_sgn_minus =  new TH1F("hdata_sgn_minus", "hdata_sgn_minus", 40, 0.1, 0.8);
        TH1F *hmc_sgn =          new TH1F("hmc_sgn", "hmc_sgn", 40, 0.1, 0.8);
        TH1F *hmc_sgn_weighted = new TH1F("hmc_weighted", "hmc_sgn_weighted", 40, 0.1, 0.8);
